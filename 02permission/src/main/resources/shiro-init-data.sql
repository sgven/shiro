...
insert into users(username, password, password_salt) values('xiejun', '123', null);
insert into user_roles(username, role_name) values('xiejun', 'role1');
insert into user_roles(username, role_name) values('xiejun', 'role2');
