...
// 这里的Realm不是通过spring获取的（即不受IoC容器管理，不会自动依赖注入，@Autowired失效），是通过shiro的ini容器获取的
//    @Autowired
//    private UserService userService;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        //交给AuthenticatingRealm使用CredentialsMatcher进行密码匹配，如果觉得人家的不好可以自定义CredentialsMatcher进行密码验证
